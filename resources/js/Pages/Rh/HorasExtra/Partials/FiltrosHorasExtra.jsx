    ...
    return (
        <div className="p-4 md:p-6 border-b theme-border space-y-4">
            <RhFilterTabs
                ...
                formatLabel={(tab) => (tab === 'TODAS' ? 'Todas' : tab.charAt(0) + tab.slice(1).toLowerCase())}
            />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                ...
                <input type="date" value={filtros.fecha_fin || ''} onChange={(e) => aplicar({ fecha_fin: e.target.value || undefined, solo_hoy: undefined })} className={`${THEME_INPUT} px-4 py-3 rounded-2xl text-[11px] font-bold`} />
            </div>
        </div>
    );
}
