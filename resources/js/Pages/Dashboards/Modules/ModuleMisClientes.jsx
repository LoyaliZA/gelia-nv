...
export default function ModuleMisClientes() {
    return (
        <Link 
            ...
            className="h-full w-full min-h-0 theme-element border-2 border-purple-500/20 p-6 rounded-[1.5rem] shadow-sm transition-all group relative overflow-hidden flex flex-col hover:border-[var(--color-primario)] outline-none"
        >
