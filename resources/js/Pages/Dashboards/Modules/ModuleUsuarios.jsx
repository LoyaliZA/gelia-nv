...
export default function ModuleUsuarios() {
    return (
        <Link 
            ...
            className="h-full w-full min-h-0 theme-element border-2 p-6 rounded-[1.5rem] shadow-sm transition-all group relative overflow-hidden flex flex-col hover:border-[var(--color-primario)] outline-none"
