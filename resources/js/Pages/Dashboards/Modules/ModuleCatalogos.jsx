...
export default function ModuleCatalogos() {
    return (
        <Link 
            ...
            className="theme-element border-2 border-blue-500/20 p-6 rounded-[1.5rem] shadow-sm transition-all group relative overflow-hidden flex flex-col hover:border-[var(--color-primario)] outline-none animate-page-reveal"
        >
