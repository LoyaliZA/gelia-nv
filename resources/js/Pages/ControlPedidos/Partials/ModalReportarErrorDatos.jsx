...
export const GRUPOS_ERROR_DATOS = [
    {
        ...
        campos: [
            ...
            { id: 'cliente_proporciona_guia', label: 'Guía proporcionada por el cliente' },
            { id: 'anexar_remision', label: 'Nota de compra en el envío' },
    ...
    },
    {
        ...
        campos: [
            ...
            { id: 'numero_cajas', label: 'Número de envíos' },
