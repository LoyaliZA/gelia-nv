...
import { BTN_SECONDARY, GELIA_SEGMENT_TABS_SCROLL, GELIA_SEGMENT_TABS_TRACK, TABS_AUDITORIA } from '../../Partials/pedidosBmaStyles';
    ...
    return (
        <div className="space-y-4">
            ...
            <div className={GELIA_SEGMENT_TABS_SCROLL}>
                <div className={`gelia-segment ${GELIA_SEGMENT_TABS_TRACK} p-1 shadow-sm`} role="tablist" aria-label="Estado de auditoría">
                    {TABS_AUDITORIA.map((tab) => {
