...
export default function ModalMotivosEsperaTurno({
    abierto,
    catalogos = {},
    procesando = false,
    onClose,
    ...
    const [motivo, setMotivo] = useState('no_se_presento');
    ...
    return createPortal(
        ...
        >
            <div
                ...
                role="dialog"
                aria-labelledby="modal-espera-titulo"
            >
                <div className="flex items-start gap-3">
                    <AlertTriangle className="w-8 h-8 text-amber-500 shrink-0" aria-hidden />
                    <div>
                        <h3 id="modal-espera-titulo" className="text-base font-black uppercase theme-text-main m-0">
                            Tiempo de espera agotado
                        </h3>
                        <p className="text-sm theme-text-muted mt-2 m-0">
                            Han pasado los minutos de espera inicial. Cierra el turno indicando el motivo.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                    <button
                        type="button"
                        className="theme-btn-danger min-h-[44px] rounded-2xl text-[10px] font-black uppercase"
                        disabled={procesando}
                        onClick={confirmar}
                    >
                        Cerrar turno
