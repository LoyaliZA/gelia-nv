...
export const DESCRIPCIONES_PERMISOS = {
    ...
    'control_pedidos.tienda.ver': 'Permite acceder a la bandeja de preparación en Tienda.',
    'control_pedidos.tienda.tomar': 'Permite tomar tareas de preparación en Tienda.',
    'control_pedidos.tienda.responder': 'Permite responder preparación de pedidos en Tienda.',
    'control_pedidos.tienda.reportar_error': 'Permite reportar incidencias de preparación en Tienda.',
    'control_pedidos.tienda.liberar': 'Permite liberar mercancía resguardada en Tienda.',
    'control_pedidos.tienda.evidencias': 'Permite adjuntar evidencias en preparación Tienda.',
    'control_pedidos.tienda.trasladar': 'Permite confirmar salida a CEDIS de mercancía preparada en Tienda.',
    'control_pedidos.tienda.ver_identificacion': 'Permite ver y descargar identificación de envíos municipales.',
    'control_pedidos.tienda.cargar_identificacion': 'Permite cargar identificación en preparación municipal.',
    'control_pedidos.tienda.generar_caratula': 'Permite generar carátula PDF de envío a municipio.',
    'control_pedidos.tienda.imprimir_caratula': 'Permite previsualizar e imprimir carátulas municipales.',
    'control_pedidos.tienda.regenerar_caratula': 'Permite regenerar una carátula con motivo auditado.',
    'control_pedidos.tienda.confirmar_caratula': 'Permite confirmar que la carátula fue colocada en el paquete.',
    'control_pedidos.preparacion.solicitar': 'Permite solicitar preparación en Tienda desde Ventas.',
    'control_pedidos.preparacion.destinatario': 'Permite capturar destinatario y datos de entrega municipal.',
    'control_pedidos.preparacion.corregir': 'Permite corregir y reenviar solicitudes de preparación en Tienda.',
    ...
    'saldos_favor.ajustar': 'Permite registrar ajustes positivos o negativos en saldos a favor.',
    'saldos_favor.cancelar': 'Permite cancelar saldos a favor.',
    'saldos_favor.configurar': 'Permite configurar reglas del módulo de saldos a favor.',
    'saldos_favor.caja': 'Permite operar la caja de aplicación de saldos a favor.',
    'saldos_favor.migrar': 'Permite importar saldos históricos conciliados.',
    ...
    'reportes.pagos_pedidos.ver': 'Consultar el reporte administrativo de pagos de pedidos validados.',
    'reportes.pagos_pedidos.ver_evidencias': 'Ver vouchers y remisiones en el reporte de pagos de pedidos.',
    'reportes.pagos_pedidos.exportar_csv': 'Exportar CSV resumen y detalle del reporte de pagos de pedidos.',
    'reportes.pagos_pedidos.exportar_pdf': 'Generar PDF con evidencias del reporte de pagos de pedidos.',
    'reportes.pagos_pedidos.ver_historico': 'Ver remisiones y evidencias históricas en el reporte de pagos.',
    'reportes.pagos_pedidos.confirmar_admin': 'Confirmar pagos revisados en el reporte administrativo de pagos.',
    'reportes.pagos_pedidos.reportar_error_admin': 'Reportar errores detectados en el reporte administrativo de pagos.',
    ...
    'tiendanube.precios.ver': 'Permite ver costos y valores de fuentes en Precios Tiendanube.',
    'tiendanube.precios.editar': 'Permite capturar costos y administrar listas de precios locales.',
    'tiendanube.precios.importar': 'Permite importar costos y listas desde archivo.',
    'tiendanube.precios.reglas.ver': 'Permite ver reglas, simular lotes, historial y revisiones de precios.',
    'tiendanube.precios.reglas.administrar': 'Permite crear, editar y archivar reglas de cálculo de precios.',
    'tiendanube.precios.aprobar': 'Permite aprobar lotes de precios simulados.',
    'tiendanube.precios.exportar': 'Permite exportar CSV de precios desde catálogo o lotes.',
    'tiendanube.precios.aplicar': 'Permite aplicar precios aprobados vía API de Tiendanube.',
    ...
    'pdv.resguardos.ver_rezagados': 'Permite consultar resguardos rezagados pendientes de recepción.',
    ...
    'pdv.turnos.cerrar_atencion': 'Permite iniciar y cerrar la atención de un turno asignado.',
    'pdv.turnos.transferir': 'Permite transferir un turno a otra persona del equipo.',
    'pdv.turnos.reatencion_asignar': 'Permite asignar manualmente re-atenciones dentro de la ventana configurada.',
    'pdv.turnos.alertas_sucursal': 'Permite designar este equipo como terminal de alertas generales de sucursal.',
    'pdv.operacion.jornada_abrir': 'Permite abrir la jornada operativa propia en piso.',
    'pdv.operacion.jornada_cerrar': 'Permite cerrar la jornada operativa propia en piso.',
    'pdv.operacion.jornada_cerrar_sucursal': 'Permite cerrar manualmente la jornada de toda la sucursal.',
    'pdv.operacion.jornada_ampliar': 'Permite ampliar el horario operativo de la sucursal.',
    'pdv.operacion.pausa': 'Permite registrar pausas operativas durante la jornada.',
    'pdv.operacion.equipo_gestionar': 'Permite a gerencia activar, desactivar y gestionar la asistencia del equipo en piso.',
    'pdv.operacion.equipo_ver': 'Permite consultar el panel gerencial del equipo en piso.',
    'pdv.pantalla_sala.abrir': 'Permite obtener y abrir la pantalla de sala de turnos.',
    'pdv.publicidad.ver': 'Permite consultar la biblioteca de publicidad de sala.',
    'pdv.publicidad.crear': 'Permite cargar contenidos y crear publicidad de sala.',
    'pdv.publicidad.editar': 'Permite editar vigencia, duración y activación de publicidad.',
    'pdv.publicidad.eliminar': 'Permite quitar piezas de la playlist de publicidad.',
    'pdv.publicidad.ordenar': 'Permite cambiar el orden de reproducción de la publicidad.',
...
export const ETIQUETAS_PERMISOS = {
    ...
    'control_pedidos.tienda.ver': 'ver bandeja tienda',
    'control_pedidos.tienda.tomar': 'tomar tarea',
    'control_pedidos.tienda.responder': 'responder preparación',
    'control_pedidos.tienda.reportar_error': 'reportar incidencia',
    'control_pedidos.tienda.liberar': 'liberar mercancía',
    'control_pedidos.tienda.evidencias': 'evidencias tienda',
    'control_pedidos.tienda.trasladar': 'confirmar salida CEDIS',
    'control_pedidos.tienda.ver_identificacion': 'ver identificación municipal',
    'control_pedidos.tienda.cargar_identificacion': 'cargar identificación municipal',
    'control_pedidos.tienda.generar_caratula': 'generar carátula',
    'control_pedidos.tienda.imprimir_caratula': 'imprimir carátula',
    'control_pedidos.tienda.regenerar_caratula': 'regenerar carátula',
    'control_pedidos.tienda.confirmar_caratula': 'confirmar carátula colocada',
    'control_pedidos.preparacion.solicitar': 'solicitar preparación',
    'control_pedidos.preparacion.destinatario': 'capturar destinatario municipal',
    'control_pedidos.preparacion.corregir': 'corregir preparación',
    ...
    'pdv.resguardos.ver_rezagados': 'ver rezagados',
    ...
    'pdv.turnos.cerrar_atencion': 'iniciar / cerrar atención',
    'pdv.turnos.transferir': 'transferir turno',
    'pdv.turnos.reatencion_asignar': 'asignar re-atención',
    'pdv.turnos.alertas_sucursal': 'alertas generales de sucursal',
    'pdv.operacion.jornada_abrir': 'abrir jornada',
    'pdv.operacion.jornada_cerrar': 'cerrar jornada',
    'pdv.operacion.jornada_cerrar_sucursal': 'cerrar jornada sucursal',
    'pdv.operacion.jornada_ampliar': 'ampliar horario',
    'pdv.operacion.pausa': 'registrar pausa',
    'pdv.operacion.equipo_gestionar': 'gestionar equipo',
    'pdv.operacion.equipo_ver': 'consultar equipo',
    'pdv.pantalla_sala.abrir': 'abrir pantalla de sala',
    'pdv.publicidad.ver': 'ver publicidad',
    'pdv.publicidad.crear': 'crear publicidad',
    'pdv.publicidad.editar': 'editar publicidad',
    'pdv.publicidad.eliminar': 'eliminar publicidad',
    'pdv.publicidad.ordenar': 'ordenar publicidad',
...
export const SUBMODULOS_UI_POR_MODULO = {
    ...
    tiendanube: [
        ...
        },
        {
            id: 'precios',
            label: 'Precios',
            descripcion: 'Catálogo de precios, costos, listas e importación',
            permisos: [
        ...
        {
            id: 'precios_reglas',
            label: 'Precios · Reglas y lotes',
            descripcion: 'Reglas de cálculo, simulación, aprobación e historial',
            permisos: [
        ...
        {
            id: 'precios_entrega',
            label: 'Precios · Exportar y aplicar',
            descripcion: 'Exportación CSV y aplicación remota por API',
            permisos: [
    ...
    reportes: [
        ...
        },
        {
            ...
            descripcion: 'Reporte administrativo de validaciones de pago BMA',
            permisos: [
    ...
    pdv: [
        {
            ...
            permisos: [
                ...
                'pdv.resguardos.ver_rezagados',
                'pdv.resguardos.reponer_vencido',
                'pdv.resguardos.autorizar_entrega_incidencia',
                'pdv.resguardos.confirmar_devolucion',
                'pdv.resguardos.corregir',
                'pdv.resguardos.ver_historial_entregas',
            ],
        },
        {
            id: 'turnos',
            ...
            permisos: [
                ...
                'pdv.turnos.cerrar_atencion',
                'pdv.turnos.transferir',
                'pdv.turnos.reatencion_asignar',
                'pdv.turnos.alertas_sucursal',
            ],
        },
        {
            id: 'operacion',
            label: 'Operación',
            descripcion: 'Jornada, pausas y cierre de sucursal',
            permisos: [
                'pdv.operacion.jornada_abrir',
                'pdv.operacion.jornada_cerrar',
                'pdv.operacion.jornada_cerrar_sucursal',
                'pdv.operacion.jornada_ampliar',
                'pdv.operacion.pausa',
                'pdv.operacion.equipo_ver',
                'pdv.operacion.equipo_gestionar',
            ],
        },
        {
            id: 'pantalla_sala',
            label: 'Pantalla de sala',
            descripcion: 'Acceso interno a la pantalla pública de turnos',
            permisos: ['pdv.pantalla_sala.abrir'],
        },
        {
            id: 'publicidad',
            label: 'Publicidad',
            descripcion: 'Biblioteca y playlist de contenidos para la pantalla de sala',
            permisos: [
                'pdv.publicidad.ver',
                'pdv.publicidad.crear',
                'pdv.publicidad.editar',
                'pdv.publicidad.eliminar',
                'pdv.publicidad.ordenar',
            ],
        },
        {
            id: 'reportes',
