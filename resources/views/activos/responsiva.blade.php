        ...
        <table style="width:100%; border-collapse:collapse;">
            <tr>
                ...
                <td style="width:62%; vertical-align:middle; padding:0;">
                    ...
                    {{-- Logos de Aromas y Bellaroma (protagonistas) --}}
                    ...
                    {{-- Logo Gelia pequeño — gestionado por --}}
                    <table style="border-collapse:collapse; margin-top:8px;">
                        <tr>
                            <td style="vertical-align:middle; padding:0 6px 0 0;">
                                {{-- SVG isotipo Gelia —  azul oscuro / negro --}}
                ...
                <td style="width:38%; vertical-align:middle; text-align:right; padding:0;">
                    ...
                    <div style="font-size:15px; font-weight:900; color:#1e3a8a; text-transform:uppercase; letter-spacing:0.3px; line-height:1.2;">
                        Carta Responsiva
                    </div>
                    ...
                    <div style="margin-top:12px; display:inline-block; background:#f1f5f9; border:1px solid #e2e8f0; border-radius:5px; padding:6px 12px; text-align:right;">
                        <div style="font-size:8.5px; color:#64748b; line-height:1.7;">
                            <strong style="color:#1e3a8a;">Folio Activo:</strong>&nbsp;{{ $activo->folio }}<br>
        ...
        <tr>
            ...
            <td>
                @if($asignacion->firmado && $asignacion->firma_ruta && Storage::disk('public')->exists($asignacion->firma_ruta))
                    ...
                    <div class="sig-digital-label-green">✔ Firmado digitalmente el {{ $asignacion->firma_fecha->format('d/m/Y H:i:s') }}</div>
                @else
    ...
    <table class="doc-footer">
        <tr>
            <td style="text-align:left; font-size:7.5px; color:#94a3b8; vertical-align:middle;">
                Documento generado por GELIA NV &nbsp;·&nbsp; Uso interno / Confidencial
            </td>
            <td style="text-align:right; font-size:7.5px; color:#94a3b8; vertical-align:middle;">
                Folio: {{ $activo->folio }} &nbsp;·&nbsp; {{ $fecha }}
            </td>
        </tr>
    </table>
