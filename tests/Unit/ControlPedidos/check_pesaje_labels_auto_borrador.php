...
/**
 * Self-check: auto-borrador al responder pesaje + badges sin solape post pre-venta.
...
$mostrarBadgePesaje = static function (string $estatusEnvio, ?string $fase, bool $forzarPesaje = false): bool {
    ...
    $preVenta = $fase === null || $fase === ''
        || in_array($fase, ['BORRADOR', 'PESAJE_PENDIENTE', 'RECHAZADO_VENDEDORA'], true);
...
$checks = [
    ...
    ['servicio auto-borrador en PESAJE_PENDIENTE', str_contains($servicio, 'FASE_PESAJE_PENDIENTE')
        && str_contains($servicio, 'FASE_BORRADOR')
