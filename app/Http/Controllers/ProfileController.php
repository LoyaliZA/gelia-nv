...
class ProfileController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $datos = $request->validate([
            ...
            'tema_visual.layout_sidebar'   => 'nullable|string|in:floating_left,floating_right,fixed,professional_left',
            'tema_visual.layout_sidebar_mobile' => 'nullable|string|in:mobile_bottom,mobile_topbar',
