...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        unset(
            $decoded['aviso_tolerancia_espera_minutos'],
            $decoded['aviso_tolerancia_prorroga_minutos'],
        );

        $row->valor = json_encode($decoded, JSON_UNESCAPED_UNICODE);
        $row->descripcion = 'Plazos de espera inicial, prórroga y ventana de reatención de turnos PDV';
        $row->save();
