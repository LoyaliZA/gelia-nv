...
use App\Http\Controllers\PuntoVenta\Operacion\ActualizarPlazosTurnosPdvController;
use App\Http\Controllers\PuntoVenta\Operacion\ConsultarPlazosTurnosPdvController;
use App\Http\Controllers\PuntoVenta\Operacion\AmpliarHorarioSucursalPdvController;
use App\Http\Controllers\PuntoVenta\Operacion\AperturaManualSucursalPdvController;
...
Route::middleware(['pdv.piso'])
    ...
    ->group(function () {
        ...
        Route::post('/jornada/abrir-sucursal', AperturaManualSucursalPdvController::class)
            ->middleware('pdv.permiso:'.PuntoVentaModulo::PERMISO_OPERACION_JORNADA_CERRAR_SUCURSAL)
            ->name('jornada.abrir_sucursal');
